...
-- This migration adds a user_id foreign key to connect candidate profiles with user accounts
...
-- Update existing candidates to link them to users by email (if possible)
